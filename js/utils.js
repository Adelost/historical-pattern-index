...
export const DRIVERS = {
    ...
    'conquest': { label: 'Conquest', color: '#6c7086' },             // overlay0
    'ethnic_ideology': { label: 'Ethnic', color: '#cba6f7' },        // mauve
    'political_ideology': { label: 'Political', color: '#fab387' },  // peach
    'economic_exploitation': { label: 'Economic', color: '#a6e3a1' } // green
};
...
export const THEME = {
    tiers: {
        'TOTAL ERASURE': {
            color: '#f38ba8',  // red - blood, total destruction (worst)
            shortLabel: 'Erasure',
        ...
        'INDUSTRIAL MEGA-EVENT': {
            color: '#fab387',  // peach - warning, machinery, bureaucracy
        ...
        'PROFIT-DRIVEN ATTRITION': {
            color: '#f9e2af',  // yellow - profit, greed, gold
            shortLabel: 'Profit',
            description: 'Death through economic extraction',
